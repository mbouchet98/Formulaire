<%@ Page Title="" Language="C#" MasterPageFile="~/NavBar.Master" AutoEventWireup="true" CodeBehind="Accueil.aspx.cs" Inherits="Formulaire2.Accueil" %>
                ...
                <div id="myCarousel" class="carousel slide col-md-12" data-ride="carousel">
                    ...
                    <div class="carousel-inner col-md-12">
                        <div class="item active">
                            <img src="image/Club.png" alt="Club" width="480" height="500" />
                        </div>
                        <div class="item">
                            <img src="image/sport.jpg" alt="sport" width="480" height="500" />
                        </div>
                    </div>
